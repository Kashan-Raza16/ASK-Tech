...
const DeliciouslySimpleSection = () => {
  ...
  return (
    <section className="bg-[#fbf7f2] min-h-screen w-full flex items-center">
      <div className="container mx-auto px-4 py-8 sm:py-12 lg:py-16 text-center w-full">
        {/* Section Title */}
        ...
        <div className="grid grid-cols-1 cursor-pointer md:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
