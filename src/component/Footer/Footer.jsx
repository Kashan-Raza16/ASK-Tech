...
import { FaXTwitter, FaInstagram, FaLinkedin, FaGithub } from 'react-icons/fa6'; // Import icons

// Main App component
const Footer = () => {
  return (
    <div className="h-[90vh] bg-gray-100 font-sans text-gray-800 flex items-center justify-center p-4 sm:p-6 md:p-8">
      {/* Footer Container */}
      <footer className="w-full max-w-6xl bg-white shadow-xl rounded-xl p-6 sm:p-8 md:p-10 lg:p-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 md:gap-12 lg:gap-16">
          ...
          <div className="flex flex-col items-start md:w-1/3 lg:w-2/5">
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              ASK Tech empowers teams to transform raw data into clear, compelling visuals — making insights easier to share, understand, and act on.
            </p>
            {/* Social Media Icons */}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 gap-y-6 gap-x-8 md:gap-x-12 lg:gap-x-20 w-full md:w-2/3 lg:w-3/5">
            ...
            <div>
              ...
              <ul className="space-y-3 text-lg">
                ...
                <li>
                  <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors duration-300">Integrations</a>
                </li>
                <li>
                  <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors duration-300">Changelog</a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-lg">
                <li>
                  <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors duration-300">Documentation</a>
                </li>
                <li>
                  <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors duration-300">Tutorials</a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-lg">
                ...
                <li>
                  <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors duration-300">Partners</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center text-lg text-gray-500 space-y-4 sm:space-y-0">
          ...
          <div className="flex space-x-4">
            ...
            <a href="#" className="hover:text-gray-900 transition-colors duration-300">Cookies Settings</a>
          </div>
        </div>
      </footer>
    </div>
