...
<<<<<<< HEAD
    ...
    >
=======
    <nav className="navbar  fixed top-0 z-30  w-full text-gray-700 text-[18px] px-4 md:px-6 py-6 flex items-center justify-between">
      
>>>>>>> 2a3848d33a61bf0462274f9e722fafb5d62abda8
